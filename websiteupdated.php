...
<body>
    ...
    <div class="navbar">
        ...
        <div id="navbar-login" class="navbar-login">
            <?php if (!$loginMessage || strpos($loginMessage, 'Invalid') !== false): ?>
                <form action="websiteupdated.php" method="post">
    ...
    <div class="intropic">
        <div class="slide fade">
            <img src="green1.jpg" alt="Image 1">
        </div>
        <div class="slide fade">
            <img src="green2.jpg" alt="Image 2">
        </div>
        <div class="slide fade">
            <img src="green3.jpg" alt="Image 3">
        </div>
    </div>
    <br>
    <div class="dots">
    ...
    <div id="product">
        ...
        <div class="product-list">
            ...
            <div class="product-item">
                ...
                <a href="https://buy.stripe.com/test_8wM03fg1n2WvdBSbII" class="buy-button">Purchase</a>
            </div>
            ...
            <div class="product-item">
                ...
                <div class="product-price">₱999.00</div>
                <a href="https://buy.stripe.com/test_eVaaHT6qN68H69q5kl" class="buy-button">Purchase</a>
            </div>
            ...
            <div class="product-item">
                ...
                <div class="product-price">₱999.00</div>
                <a href="https://buy.stripe.com/test_5kA7vH9CZ7cLapG3ce" class="buy-button">Purchase</a>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="product-list">
                ...
                <div class="product-item">
                    ...
                    <a href="https://buy.stripe.com/test_5kAdU53eBbt141ieV3" class="buy-button">Purchase</a>
                </div>
                ...
                <div class="product-item">
                    ...
                    <div class="product-price">₱999.99</div>
                    <a href="https://buy.stripe.com/test_4gweY902p2Wv69q4gq" class="buy-button">Purchase</a>
                </div>
                ...
                <div class="product-item">
                    ...
                    <div class="product-price">₱999.99</div>
                    <a href="https://buy.stripe.com/test_aEU8zLg1n9kTeFWbIT" class="buy-button">Purchase</a>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="product-list">
                    ...
                    <div class="product-item">
                        ...
                        <div class="product-price">₱999.00</div>
                        <a href="https://buy.stripe.com/test_9AQeY97uRaoXgO4147" class="buy-button">Purchase</a>
                    </div>
                    ...
                    <div class="product-item">
                        ...
                        <div class="product-price">₱999.00</div>
                        <a href="https://buy.stripe.com/test_5kA03faH32Wv0P66os" class="buy-button">Purchase</a>
                    </div>
                    ...
                    <div class="product-item">
                        ...
                        <div class="product-price">₱999.00</div>
                        <a href="https://buy.stripe.com/test_aEU8zLaH3fJhgO45kp" class="buy-button">Purchase</a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="product-list">
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-price">₱999.99</div>
                            <a href="https://buy.stripe.com/test_bIYcQ14iFaoX55m28e" class="buy-button">Purchase</a>
                        </div>
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-price">₱999.99</div>
                            <a href="https://buy.stripe.com/test_7sIeY97uR54D0P6007" class="buy-button">Purchase</a>
                        </div>
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-price">₱999.99</div>
                            <a href="https://buy.stripe.com/test_7sI9DP6qN8gP1Ta6ow" class="buy-button">Purchase</a>
                        </div>
                    </div>
    </div>
